...
public class ShoppingCartServiceImpl implements ShoppingCartService {
	...
	public CartItem addClothToShoppingCart(Cloth cloth, User user, int qty, String size) {
		ShoppingCart shoppingCart = this.getShoppingCart(user);
		CartItem cartItem = shoppingCart.findCartItemByClothAndSize(cloth.getId(), size);
	...
	public void updateCartItem(CartItem cartItem, Integer qty) {
		...
		} else if (cartItem.getCloth().hasStock(qty)) {
			cartItem.setQty(qty);
